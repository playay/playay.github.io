...
感受一下 “你溜逼” 和 “你溜笔” 这两句话的区别：第一话里的三个字音高是不断上升的，第二句话升到最后一个字的时候是降下来的。( 其实我是用 “你妹妹” 的最后一个字 轻读/重读 来区别的。 )   

用笛子试着吹一下 *“你溜逼你溜笔”*，可以吹 *[1 2 3 1 2 1]* ，也可以吹 *[4 5 6 4 5 4]*，都挺像的。   
...
完整的说，C调陶笛的C，表示全按(不含小孔)的时候，这个笛子发出的声音频率等于 C 这个字母所代表的频率。 
